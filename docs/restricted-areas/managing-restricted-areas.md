---
sidebar_position: 2
title: Managing Restricted Areas
---
...
Managers and Admins can create restricted areas.

1. Go to **Restricted Areas** in the sidebar
2. Click **Create restricted area**
3. Fill in the form:
...
Each restricted area has a detail page with five tabs:

### Overview
- Verification status with a **Verify Controls** button (shows a red banner if overdue)
- Summary tiles: days since verification, linked defects count, linked assets count, risk status
- Area information, location, controls, GPS coordinates, hazard details, PPE, permits, and signage
- Photo gallery

### Defects
- A mini risk matrix showing linked defects by risk score
...
The verification date and verifier are recorded automatically.
